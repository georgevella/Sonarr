...
namespace NzbDrone.App.Test
{
    ...
    public class ContainerFixture : TestBase
    {
        ...
        {
            var first = _container.ResolveAll<IHandle<RemoteItemGrabbedEvent>>().OfType<DownloadMonitoringService>().Single();
            var second = _container.ResolveAll<IHandle<RemoteItemGrabbedEvent>>().OfType<DownloadMonitoringService>().Single();

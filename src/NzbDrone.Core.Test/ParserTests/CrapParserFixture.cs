    ...
    public class CrapParserFixture : CoreTest
    {
        ...
        public void should_not_parse_md5()
        {
            ...
            for (int i = 0; i < repetitions; i++)
            {
                ...
                if (Parser.Parser.ParseEpisodeTitle(hash) == null)
                    success++;
            }
        ...
        public void should_not_parse_random(int length)
        {
            ...
            for (int i = 0; i < repetitions; i++)
            {
                ...
                if (Parser.Parser.ParseEpisodeTitle(hash.ToString()) == null)
                    success++;
            }
        ...
        {
            Parser.Parser.ParseEpisodeTitle(fileName).Should().BeNull();
        }
    }
}
